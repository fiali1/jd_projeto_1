...
public class UIManager : MonoBehaviour {
    ...
    void UpdateResUI(ResolutionScreenType type, int score)
    {
        ...
        switch (type)
        {
            case ResolutionScreenType.Correct:
                ...
                uIElements.ResolutionStateInfoText.text = "ACERTOU!";
            ...
            case ResolutionScreenType.Finish:
                ...
                uIElements.HighScoreText.text = ((highscore > events.StartupHighscore) ? "<color=yellow>Novo </color>" : string.Empty) + "Recorde: " + highscore;
                break;
        }
    }
    ...
    void UpdateScoreUI()
    {
        uIElements.ScoreText.text = "Pontuação: " + events.CurrentFinalScore;
    }
}